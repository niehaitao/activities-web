  ...
  return (
    <div className={`activities ${css(styles.content_box, styles.content_box_layout)}`}>
      ...
      <div className={css(styles.flex5, styles.flex5_layout)}>
        <Git value={REACT_APP_GIT_HASH} />
        <Build value={REACT_APP_BUILD} />
      </div>
    </div>
  );
      ...
      <div className={css(styles.flex, styles.flex_layout5)}>
        <div className={css(styles.flex7_col)}>
          <div className={css(styles.cover_group4, styles.cover_group4_layout)}>
            <h4 className={css(styles.build, styles.build_layout)}>{"Build"}</h4>
          </div>
        </div>
      ...
      <div className={css(styles.flex, styles.flex_layout)}>
        <div className={css(styles.flex6_col)}>
          <div className={css(styles.cover_group3, styles.cover_group3_layout)}>
            <h4 className={css(styles.git, styles.git_layout)}>{"GIT"}</h4>
          </div>
        </div>
        <div className={css(styles.flex6_spacer)} />
        <h4 className={css(styles.highlights3, styles.highlights3_layout)}>{value}</h4>
      </div>
    );
  }
...
const styles = StyleSheet.create({
  ...
  git_layout: {
    position: "relative",
    flexGrow: 1,
    margin: "2px 13.28px 2px 13.72px",
  },
  flex6_spacer: {
    display: "flex",
    flex: "0 1 20px",
